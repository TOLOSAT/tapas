...
#define GPIO_INPUT_MASK                (0u << 0) /**< GPIO mode input mask */
#define GPIO_OUTPUT_MASK               (1u << 0) /**< GPIO mode ouput mask */
#define GPIO_INTERRUPT_MASK            (1u << 1) /**< GPIO mode interrupt mask */
#define GPIO_EDGE_MASK                 (1u << 2) /**< GPIO mode state/edge mask */
#define GPIO_LOW_OR_FALLING_MASK       (0u << 3) /**< GPIO mode state/edge type low/falling mask */
#define GPIO_HIGH_OR_RISING_MASK       (1u << 3) /**< GPIO mode state/edge type high/rising mask */
#define GPIO_ALTERNATE_MASK            (1u << 4) /**< GPIO mode alternate funtion */
...
#define GPIO_MODE_INTERRUPT_RISING_EDGE \
    (GPIO_INPUT_MASK | GPIO_INTERRUPT_MASK | GPIO_EDGE_MASK | GPIO_LOW_OR_FALLING_MASK) /**< Interrupt on pin rising edge mode */
#define GPIO_MODE_INTERRUPT_FALLING_EDGE \
    (GPIO_INPUT_MASK | GPIO_INTERRUPT_MASK | GPIO_EDGE_MASK | GPIO_HIGH_OR_RISING_MASK) /**< Interrupt on pin falling edge mode */
...
typedef enum
{
    GPIO_PIN_RESET = 0u, /**< @brief GPIO state is reset (0) */
    GPIO_PIN_SET   = 1u, /**< @brief GPIO state is set (1) */
} GPIO_PinState;
