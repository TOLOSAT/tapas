...
#define LED_STATUS_CLK_ENABLE()     __HAL_RCC_GPIOA_CLK_ENABLE()
#define LED_STATUS_CLK_DISABLE()    __HAL_RCC_GPIOA_CLK_DISABLE()
...
#define USER_BUTTON_CLK_ENABLE()    __HAL_RCC_GPIOC_CLK_ENABLE()
#define USER_BUTTON_CLK_DISABLE()   __HAL_RCC_GPIOC_CLK_DISABLE()
