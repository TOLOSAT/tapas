...
#define KERNEL_TEXT_REGION_BASE_ADDR   BSP_KERNEL_TEXT_REGION_BASE_ADDR /**< Kernel text region base address */
#define KERNEL_TEXT_REGION_SIZE        BSP_KERNEL_TEXT_REGION_SIZE      /**< Kernel text region size */
...
#define KERNEL_DATA_REGION_BASE_ADDR   BSP_KERNEL_DATA_REGION_BASE_ADDR /**< Kernel data region base address */
#define KERNEL_DATA_REGION_SIZE        BSP_KERNEL_DATA_REGION_SIZE      /**< Kernel data region size */
...
#define KERNEL_RODATA_REGION_BASE_ADDR BSP_KERNEL_RODATA_REGION_BASE_ADDR /**< Kernel rodata region base address */
#define KERNEL_RODATA_REGION_SIZE      BSP_KERNEL_RODATA_REGION_SIZE      /**< Kernel rodata region size */
...
#define DMABUFF_REGION_BASE_ADDR       BSP_DMABUFF_REGION_BASE_ADDR /**< DMA buffer region base address */
#define DMABUFF_REGION_SIZE            BSP_DMABUFF_REGION_SIZE      /**< DMA buffer region size */
...
#endif                                                  /* CONFIG_HAS_FMC_NAND_MEMORY */
...
/* allocate), non-shareable, executable                                       */
/* -------------------------------------------------------------------------- */
#define KERNEL_TCM_TEXT_REGION_NO          8u                                   /**< Kernel text region numero */
#define KERNEL_TCM_TEXT_REGION_BASE_ADDR   BSP_KERNEL_TCM_TEXT_REGION_BASE_ADDR /**< Kernel text region base address */
#define KERNEL_TCM_TEXT_REGION_SIZE        BSP_KERNEL_TCM_TEXT_REGION_SIZE      /**< Kernel text region size */
#define KERNEL_TCM_TEXT_REGION_XN          0                                    /**< Kernel text region execute permission : executable */
#define KERNEL_TCM_TEXT_REGION_AP          ARM_MPU_AP_PRO                       /**< Kernel text region access permission : privileged read-only */
#define KERNEL_TCM_TEXT_REGION_TEX         0b001                                /**< Kernel text region TEX : 0b001 (Normal, WBWA) */
#define KERNEL_TCM_TEXT_REGION_S           0                                    /**< Kernel text region shareability : non shareable */
#define KERNEL_TCM_TEXT_REGION_C           1                                    /**< Kernel text region cacheability : cacheable */
#define KERNEL_TCM_TEXT_REGION_B           1                                    /**< Kernel text region bufferability : bufferable */
...
/* allocate), non-shareable, execute-never                                    */
/* -------------------------------------------------------------------------- */
#define KERNEL_TCM_DATA_REGION_NO          9u                                   /**< Kernel data region numero */
#define KERNEL_TCM_DATA_REGION_BASE_ADDR   BSP_KERNEL_TCM_DATA_REGION_BASE_ADDR /**< Kernel data region base address */
#define KERNEL_TCM_DATA_REGION_SIZE        BSP_KERNEL_TCM_DATA_REGION_SIZE      /**< Kernel data region size */
#define KERNEL_TCM_DATA_REGION_XN          1                                    /**< Kernel data region execute permission : execute never */
#define KERNEL_TCM_DATA_REGION_AP          ARM_MPU_AP_PRIV                      /**< Kernel data region access permission : privileged read/write */
#define KERNEL_TCM_DATA_REGION_TEX         0b001                                /**< Kernel data region TEX : 0b001 (Normal, WBWA) */
#define KERNEL_TCM_DATA_REGION_S           0                                    /**< Kernel data region shareability : non shareable */
#define KERNEL_TCM_DATA_REGION_C           1                                    /**< Kernel data region cacheability : cacheable */
#define KERNEL_TCM_DATA_REGION_B           1                                    /**< Kernel data region bufferability : bufferable */
...
/* allocate), non-shareable, execute-never                                    */
/* -------------------------------------------------------------------------- */
#define KERNEL_TCM_RODATA_REGION_NO        10u                                    /**< Kernel rodata region numero */
#define KERNEL_TCM_RODATA_REGION_BASE_ADDR BSP_KERNEL_TCM_RODATA_REGION_BASE_ADDR /**< Kernel rodata region base address */
#define KERNEL_TCM_RODATA_REGION_SIZE      BSP_KERNEL_TCM_RODATA_REGION_SIZE      /**< Kernel rodata region size */
#define KERNEL_TCM_RODATA_REGION_XN        1                                      /**< Kernel rodata region execute permission : execute never */
#define KERNEL_TCM_RODATA_REGION_AP        ARM_MPU_AP_PRO /**< Kernel rodata region access permission : privileged read-only */
#define KERNEL_TCM_RODATA_REGION_TEX       0b001          /**< Kernel rodata region TEX : 0b001 (Normal, WBWA) */
#define KERNEL_TCM_RODATA_REGION_S         0              /**< Kernel rodata region shareability : non shareable */
#define KERNEL_TCM_RODATA_REGION_C         1              /**< Kernel rodata region cacheability : cacheable */
#define KERNEL_TCM_RODATA_REGION_B         1              /**< Kernel rodata region bufferability : bufferable */
...
void InitMPU(void)
{
    ...
    rasr = ARM_MPU_RASR_EX(KERNEL_TCM_TEXT_REGION_XN,                                 //
                           ...
                           ARM_MPU_ACCESS_(                                           //
                               KERNEL_TCM_TEXT_REGION_TEX,                            //
                               KERNEL_TCM_TEXT_REGION_S,                              //
                               KERNEL_TCM_TEXT_REGION_C,                              //
                               KERNEL_TCM_TEXT_REGION_B                               //
                               ),                                                     //
                           0,                                                         //
                           KERNEL_TCM_TEXT_REGION_SIZE                                //
    );
    ARM_MPU_SetRegion(rbar, rasr);
    ...
    rasr = ARM_MPU_RASR_EX(KERNEL_TCM_DATA_REGION_XN,                                 //
                           ...
                           ARM_MPU_ACCESS_(                                           //
                               KERNEL_TCM_DATA_REGION_TEX,                            //
                               KERNEL_TCM_DATA_REGION_S,                              //
                               KERNEL_TCM_DATA_REGION_C,                              //
                               KERNEL_TCM_DATA_REGION_B                               //
                               ),                                                     //
                           0,                                                         //
                           KERNEL_TCM_DATA_REGION_SIZE                                //
    );
    ARM_MPU_SetRegion(rbar, rasr);
    ...
    rasr = ARM_MPU_RASR_EX(KERNEL_TCM_RODATA_REGION_XN,                                   //
                           ...
                           ARM_MPU_ACCESS_(                                               //
                               KERNEL_TCM_RODATA_REGION_TEX,                              //
                               KERNEL_TCM_RODATA_REGION_S,                                //
                               KERNEL_TCM_RODATA_REGION_C,                                //
                               KERNEL_TCM_RODATA_REGION_B                                 //
                               ),                                                         //
                           0,                                                             //
                           KERNEL_TCM_RODATA_REGION_SIZE                                  //
    );
    ARM_MPU_SetRegion(rbar, rasr);
#endif /* CONFIG_HAS_TCM */
