...
typedef enum
{
    HAL_UART_BUFFER_NORMAL   = 0u, /**< @brief UART normal mode */
    HAL_UART_BUFFER_CIRCULAR = 1u  /**< @brief UART circular buffer mode */
} HAL_UART_BufferModeTypeDef;
...
typedef struct
{
    ...
    HAL_UART_BufferModeTypeDef buffer_mode; /**< @brief UART buffer mode */
...
extern HAL_StatusTypeDef cmsdk_UartRxAbort(UART_HandleTypeDef *uart);
