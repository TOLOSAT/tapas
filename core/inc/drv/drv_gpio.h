...
extern coreStatus_t GpioOpen(gpioInst_t *gpio_inst);
extern coreStatus_t GpioWrite(gpioInst_t *gpio_inst, gpioValue_t value);
extern coreStatus_t GpioRead(gpioInst_t *gpio_inst, gpioValue_t *value);
extern coreStatus_t GpioIoctl(gpioInst_t *gpio_inst, uint32_t cmd, void *data, uint32_t data_size);
extern coreStatus_t GpioClose(gpioInst_t *gpio_inst);
